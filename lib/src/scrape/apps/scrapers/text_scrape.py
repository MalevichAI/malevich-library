...
@scheme()
class ScrapeLinksText(BaseModel):
    link: str


@processor()
def scrape_text(
    scrape_links: DF[ScrapeLinksText],
    ...
    ## Spider Options:
        ...
        Args:
            scrape_links (DF[ScrapeLinksText]): A dataframe with a column named `link` containing web links.
